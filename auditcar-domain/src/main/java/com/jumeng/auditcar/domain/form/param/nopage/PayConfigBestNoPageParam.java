 ...
 * @Version 1.0
 **/
@ApiModel(description = "翼支付配置查询条件")
@Data
public class PayConfigBestNoPageParam extends DataQueryObjectSort {

    public PayConfigBestNoPageParam() {
    }

    public PayConfigBestNoPageParam(String shopInfoId, String merchantId) {
